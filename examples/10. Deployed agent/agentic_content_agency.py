...
crew = Team(
    ...
    members=[content_planner, web_agent, hackernews_agent],
...
agent_os = AgentOS(
    description="Content planning team",
    agents=[hackernews_agent, content_planner, web_agent],
    teams=[crew],
...
if __name__ == "__main__":
    agent_os.serve(
        app="agentic_content_agency:app", reload=True
    )
